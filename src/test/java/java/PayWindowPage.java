...
public class PayWindowPage extends BaseSeleniumPage {
    ...
    @FindBy(xpath = "//app-card-input/form/div[1]/div[1]/app-input/div/div/div[@class = 'content ng-tns-c2312288139-1']")
    private WebElement cardNumberPlaceholder;

    @FindBy(xpath = "//div/label [@class='ng-tns-c2312288139-4 ng-star-inserted']")
    private WebElement cardExpirationPlaceholder;

    @FindBy(xpath = "//div/label [@class='ng-tns-c2312288139-5 ng-star-inserted']")
